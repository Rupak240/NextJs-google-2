    ...
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        <form className="flex flex-grow border border-gray-200 rounded-full shadow-lg max-w-3xl items-center px-6 py-3 ml-10 mr-5">
          ...
          />
          <XIcon
            className="h-7 sm:mr-3 cursor-pointer text-gray-700 transition duration-100 transform hover:scale-125"
        ...
        <Avatar
          className="ml-auto"
          url="https://avatars.githubusercontent.com/u/61515918?v=4"
        />
      </div>
